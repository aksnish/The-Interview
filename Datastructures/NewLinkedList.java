...
public class NewLinkedList<AnyType> implements Iterable<AnyType>
{
 ...
 /**
   ...
   *  Complexity: O(n^2)
   */
   public  NewLinkedList<AnyType> copy1()
   {
      NewLinkedList<AnyType> twin = new NewLinkedList<AnyType>();
      Node<AnyType> tmp = head;
      while(tmp != null)
      {
 ...
 /**
   ...
   *  Complexity: O(n)
   */
   public NewLinkedList<AnyType> copy2()
   {
      NewLinkedList<AnyType> twin = new NewLinkedList<AnyType>();
      Node<AnyType> tmp = head;
      while(tmp != null)
 ...
 /**
   ...
   *  Complewxity: O(n)
   */
   public NewLinkedList<AnyType> reverse()
   {
      NewLinkedList<AnyType> list = new NewLinkedList<AnyType>();
      Node<AnyType> tmp = head;
      while(tmp != null)
      {
 ...
 /**
   ...
   *  Complexity: O(n)
   */
   public NewLinkedList<AnyType> copy3()
   {
      NewLinkedList<AnyType> twin = new NewLinkedList<AnyType>();
      Node<AnyType> tmp = head;
...
/*****   Include the main() for testing and debugging  *****/
   ...
   public static void main(String[] args)
   {
      ...
      System.out.println(list);
		...
		NewLinkedList<String> twin = list.copy3();
